...
namespace AppCitas.UnitTests.Tests
{
    public class UsersControllerTests
    {
        ...
        public async Task GetUsersNoPagination_ShouldBeOK(string statusCode, string username, string password)
        {
            // Arrange
        ...
        [Theory]
        [InlineData("OK", "wagner", "Pa$$w0rd",1,10)]
        public async Task GetUsersWithPagination_ShouldBeOK(string statusCode, string username, string password, int pageSize, int pageNumber)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
        ...
        public async Task GetUserByUsername_ShouldBeOK(string statusCode, string username, string password)
        {
            // Arrange
            var user = await LoginHelper.LoginUser(username, password);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", user.Token);
        ...
        [Theory]
        [InlineData("NoContent", "wagner", "Pa$$w0rd","IntroductionU","LookingForU","InterestsU","CityU","CountryU")]
        public async Task UpdateUser_ShouldBeNoContent(string statusCode, string username, string password,string introduction,string lookingFor,string interests, string city,string country)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
            var user = await LoginHelper.LoginUser(username, password);
        ...
        [Theory]
        [InlineData("Created", "wagner", "Pa$$w0rd", "../../../Photo.jpg")]
        public async Task AddPhoto_ShouldBeCreated(string statusCode, string username, string password, string file)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
            var user = await LoginHelper.LoginUser(username, password);
        ...
        [Theory]
        [InlineData("NoContent", "rosa", "Pa$$w0rd", "../../../Photo2.jpg")]
        public async Task SetMainPhoto_ShouldBeOK(string statusCode, string username, string password, string file)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
            var user = await LoginHelper.LoginUser(username, password);
        ...
        [Theory]
        [InlineData("OK", "rosa", "Pa$$w0rd", "../../../Photo3.jpg")]
        ...
        [Theory]
        [InlineData("NotFound", "hewitt", "Pa$$w0rd", "420")]
        public async Task DeletePhoto_ShouldBeNotFound(string statusCode, string username, string password, string id)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
            var user = await LoginHelper.LoginUser(username, password);
